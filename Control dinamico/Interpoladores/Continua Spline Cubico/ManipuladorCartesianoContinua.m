...
plot3([M5(1,4), Z(1,4)],[M5(2,4),Z(2,4)],[M5(3,4),Z(3,4)],'g')
hold on
...
SX6 = plot3([Z(1,4) Z(1,4)+Z(1,1)],[Z(2,4) Z(2,4)+Z(2,1)],[Z(3,4) Z(3,4)+Z(3,1)],'red','LineStyle','--','LineWidth',2);
SY6 = plot3([Z(1,4) Z(1,4)+Z(1,2)],[Z(2,4) Z(2,4)+Z(2,2)],[Z(3,4) Z(3,4)+Z(3,2)],'green','LineStyle','--','LineWidth',2);
SZ6 = plot3([Z(1,4) Z(1,4)+Z(1,3)],[Z(2,4) Z(2,4)+Z(2,3)],[Z(3,4) Z(3,4)+Z(3,3)],'blue','LineStyle','--','LineWidth',2);
